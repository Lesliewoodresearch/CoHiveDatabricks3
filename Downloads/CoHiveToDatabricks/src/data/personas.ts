...
export const hexPersonas: HexPersonaConfig[] = [
  ...
  {
    hexId: 'Luminaries',
    hexName: 'External Experts',
    level1Label: 'Expert Type',
    level2Label: 'Domain',
    level3Label: 'Specific Role',
    description: 'Select external experts to provide insights and perspectives',
    options: [
      {
        id: 'industry-experts',
        category: 'Industry Experts',
        description: 'Professionals with deep domain expertise',
        subcategories: [
          {
            id: 'tech',
            name: 'Technology',
            ...
            roles: [
              { id: 'luminaries-tech-cto', name: 'Chief Technology Officer' },
              { id: 'luminaries-tech-engineer', name: 'Senior Software Engineer' },
              { id: 'luminaries-tech-pm', name: 'Product Manager' }
            ]
          },
          {
            id: 'healthcare',
            ...
            roles: [
              { id: 'luminaries-health-cmo', name: 'Chief Medical Officer' },
              { id: 'luminaries-health-admin', name: 'Hospital Administrator' },
              { id: 'luminaries-health-researcher', name: 'Clinical Researcher' }
            ]
          },
          {
            id: 'finance',
            name: 'Finance',
            description: 'Financial services experts',
            roles: [
              { id: 'luminaries-finance-cfo', name: 'Chief Financial Officer' },
              { id: 'luminaries-finance-analyst', name: 'Investment Analyst' }
            ]
          }
        ]
      },
      {
        id: 'academic-experts',
        category: 'Academic Experts',
        description: 'Researchers and academic thought leaders',
        subcategories: [
          {
            id: 'research',
            name: 'Research',
            description: 'University researchers',
            roles: [
              { id: 'luminaries-academic-professor', name: 'University Professor' },
              { id: 'luminaries-academic-scientist', name: 'Research Scientist' }
            ]
          },
          {
            id: 'social-sciences',
            name: 'Social Sciences',
            description: 'Behavioral and social experts',
            roles: [
              { id: 'luminaries-social-psychologist', name: 'Behavioral Psychologist' },
              { id: 'luminaries-social-sociologist', name: 'Sociologist' }
            ]
          }
        ]
      },
      {
        id: 'creative-experts',
        category: 'Creative Experts',
        description: 'Design and creative professionals',
        subcategories: [
          {
            id: 'design',
            name: 'Design',
            description: 'UX, UI, and design thinking experts',
            roles: [
              { id: 'luminaries-design-ux', name: 'UX Designer' },
              { id: 'luminaries-design-strategist', name: 'Design Strategist' }
            ]
          },
          {
            id: 'marketing',
            name: 'Marketing',
            description: 'Brand and marketing experts',
            roles: [
              { id: 'luminaries-marketing-brand', name: 'Brand Strategist' },
              { id: 'luminaries-marketing-digital', name: 'Digital Marketing Director' }
            ]
          }
        ]
      }
