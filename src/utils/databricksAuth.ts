...
const OAUTH_CONFIG: DatabricksOAuthConfig = {
  clientId: getEnvVar('VITE_DATABRICKS_CLIENT_ID'),
  redirectUri: getEnvVar('VITE_DATABRICKS_REDIRECT_URI') || (typeof window !== 'undefined' ? `${window.location.origin}/oauth/callback` : ''),
