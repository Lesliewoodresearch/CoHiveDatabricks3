...
export const hexPersonas: HexPersonaConfig[] = [
  ...
  // --------------------------------------------------------------------------
  {
    ...
    level2Label: 'Consumer Category',
    level3Label: 'Consumer Persona',
    description: 'Select consumer buyer personas to evaluate ideas and concepts',
    options: [
      {
        id: 'buyer-behavior',
        category: 'Buyer Behavior',
        description: 'Purchase behavior and buyer personas',
        subcategories: [
          {
            id: 'b2c',
            name: 'B2C Buyers',
            description: 'Individual consumer buyers',
            roles: [
