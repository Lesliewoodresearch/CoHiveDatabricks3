                  ...
                  <div className="space-y-0">
                    {personaConfig.options.map((opt) => (
                      <div key={opt.id}>
                        ...
                        {selectedLevel1.includes(opt.id) && opt.subcategories && (
                          <div className="ml-2 pl-4 border-l-2 border-blue-300 mt-1 mb-1 space-y-1">
                            {opt.subcategories.map((level2) => (
                              <div key={level2.id}>
                                ...
                                {selectedLevel2.includes(level2.id) && level2.roles && (
                                  <div className="ml-2 pl-4 border-l-2 border-green-300 mt-1">
