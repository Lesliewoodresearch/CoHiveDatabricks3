...
export function AssessmentModal({
  ...
  const formatContent = (content: string): React.ReactNode => {
    ...
    return lines.map((line, i) => {
      // Persona headers (e.g., **Persona Name:** or ### Persona Name)
      ...
      // Bold headings (e.g., **Key Insights:** or **Recommendations:**)
      const boldHeadingMatch = line.match(/^\*\*([^*]+):\*\*$/);
      if (boldHeadingMatch) {
        return <h4 key={i} className="font-semibold text-gray-900 text-sm mt-3 mb-1">{boldHeadingMatch[1]}:</h4>;
      }
      ...
      // Checkmark bullets (e.g., - ✅ Citation verified)
