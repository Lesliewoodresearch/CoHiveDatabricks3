...
KNOWLEDGE BASE FILES (cite these as [Source: filename.ext]):
${kbContext}

CITATION RULES (strictly enforced):
- Every factual claim MUST be cited: [Source: exact_filename.ext]
- Only cite files listed above in the Knowledge Base
- Label uncited general knowledge as [General Knowledge]
- Be precise with citations - use exact filenames
...
Provide your detailed analysis as ${persona.name}. Include inline citations [Source: filename.ext] for every claim you make from the knowledge base files.

Format your response clearly with:
- Your main insights
- Specific recommendations
- All claims cited with [Source: filename.ext]`;
